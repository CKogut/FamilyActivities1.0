        ...
        Optional<Activity> result = activityRepository
            ...
            .map(existingActivity -> {
                ...
                if (activity.getMinParticipants() != null) {
                    existingActivity.setMinParticipants(activity.getMinParticipants());
                }
                ...
                if (activity.getInOrOut() != null) {
                    existingActivity.setInOrOut(activity.getInOrOut());
                }
                if (activity.getHomeOrAway() != null) {
                    existingActivity.setHomeOrAway(activity.getHomeOrAway());
                }
