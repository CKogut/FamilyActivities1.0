...
class ActivityResourceIT {
    ...
    private static final String DEFAULT_IN_OR_OUT = "AAAAAAAAAA";
    private static final String UPDATED_IN_OR_OUT = "BBBBBBBBBB";

    private static final String DEFAULT_HOME_OR_AWAY = "AAAAAAAAAA";
    private static final String UPDATED_HOME_OR_AWAY = "BBBBBBBBBB";
    ...
    public static Activity createEntity(EntityManager em) {
        Activity activity = new Activity()
            ...
            .time(DEFAULT_TIME)
            .inOrOut(DEFAULT_IN_OR_OUT)
            .homeOrAway(DEFAULT_HOME_OR_AWAY);
        return activity;
    }
    ...
    public static Activity createUpdatedEntity(EntityManager em) {
        Activity activity = new Activity()
            ...
            .time(UPDATED_TIME)
            .inOrOut(UPDATED_IN_OR_OUT)
            .homeOrAway(UPDATED_HOME_OR_AWAY);
        return activity;
    }
    ...
    void createActivity() throws Exception {
        ...
        assertThat(testActivity.getInOrOut()).isEqualTo(DEFAULT_IN_OR_OUT);
        assertThat(testActivity.getHomeOrAway()).isEqualTo(DEFAULT_HOME_OR_AWAY);
    }
    ...
    void getAllActivities() throws Exception {
        ...
        restActivityMockMvc
            ...
            .andExpect(jsonPath("$.[*].inOrOut").value(hasItem(DEFAULT_IN_OR_OUT)))
            .andExpect(jsonPath("$.[*].homeOrAway").value(hasItem(DEFAULT_HOME_OR_AWAY)));
    }
    ...
    void getActivity() throws Exception {
        ...
        restActivityMockMvc
            ...
            .andExpect(jsonPath("$.inOrOut").value(DEFAULT_IN_OR_OUT))
            .andExpect(jsonPath("$.homeOrAway").value(DEFAULT_HOME_OR_AWAY));
    }
    ...
    void putExistingActivity() throws Exception {
        ...
        assertThat(testActivity.getInOrOut()).isEqualTo(UPDATED_IN_OR_OUT);
        assertThat(testActivity.getHomeOrAway()).isEqualTo(UPDATED_HOME_OR_AWAY);
    }
    ...
    void partialUpdateActivityWithPatch() throws Exception {
        ...
        partialUpdatedActivity.description(UPDATED_DESCRIPTION).cost(UPDATED_COST).time(UPDATED_TIME);
